...
# prison data during 1970-2018 in Cook County, IL with added location col
...
# jail data during 1970-2018 in Cook County, IL with added location col
...
prison_plot <- ggplot(prison_over_years, aes(x = black_prison_pop, y = total_prison_pop)) +
  geom_point() +
  labs(title = "Black versus Total Prison Population in Cook County, IL, 1970-2013",
...
jail_plot <- ggplot(jail_over_years, aes(x = black_jail_pop, y = total_jail_pop)) +
  geom_point() +
  labs(title = "Black versus Total Jail Population in Cook County, IL, 1970-2013",
